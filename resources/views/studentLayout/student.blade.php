...
<body>
    ...
    <nav x-data="{ open: false }" class="bg-white absolute top-0 w-full z-50 border-b border-black">
        <div class="max-w-screen-xl mx-auto flex items-center justify-between p-4">
            <!-- Logo -->
                ...
                <form class="hidden lg:block w-full max-w-lg lg:max-w-md mx-auto ">
                    ...
                    <div class="relative mr-2">
                        ...
                        <!-- Search Input -->
                        <input type="search" id="default-search" class="block w-full p-4 ps-12 text-sm text-black border border-white rounded-lg bg-white focus:ring-0 focus:outline-none focus:border-white" placeholder="Search Course..." required />
            ...
            <div class="hidden md:flex items-center space-x-6">
                <a href="" class="text-black hover:text-violet-600 transition">All Courses</a>
                @if(auth()->user()->role === 'Teacher')
